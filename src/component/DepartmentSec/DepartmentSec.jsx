...
import department from "/public/image/department.jpg"
import DepartmentFooter from '../DepartmentFooter/DepartmentFooter';
function DepartmentSec() {
        ...
        <div className="row">
            ...
            <div className="tab-content">
                ...
                <div className="row">
                    ...
                    <img src={department} alt="" className="img-fluid"/>
                    </div>
                </div>
                </div>
